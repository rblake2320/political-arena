...
- [ ] Re-integrate staff write-action modals into the redesigned Race (issue-challenge / outside-ad / rebuttal-claim). Read-view shipped; write logic preserved in pre-redesign Race.tsx in git history.
