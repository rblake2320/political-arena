  ...
  const examples = [
    {
      ...
      mediaUrl: 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Daisy_%281964%29.webm',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:Daisy_(1964).webm',
      sourceLabel: 'SAMPLE - HISTORICAL AD (public-domain Wikimedia video)',
      description: 'Sample direct-video political ad used to demonstrate the outside-ad response workflow. This is a public-domain historical campaign ad, not an ad by the current candidate or campaign.',
      disclaimer: 'SAMPLE - HISTORICAL AD. Public-domain historical ad for workflow demonstration; not paid for by the current candidate or campaign.',
    },
    {
      ...
      mediaUrl: 'https://upload.wikimedia.org/wikipedia/commons/d/d8/1952_Eisenhower_Political_Ad_-_I_Like_Ike_-_Presidential_Campaign_Ad.webm',
      sourceUrl: 'https://commons.wikimedia.org/wiki/File:1952_Eisenhower_Political_Ad_-_I_Like_Ike_-_Presidential_Campaign_Ad.webm',
      sourceLabel: 'SAMPLE - HISTORICAL AD (public-domain Wikimedia video)',
      description: 'Sample direct-video political ad used to demonstrate the outside-ad response workflow. This is a public-domain historical campaign ad, not an ad by the current candidate or campaign.',
      disclaimer: 'SAMPLE - HISTORICAL AD. Public-domain historical ad for workflow demonstration; not paid for by the current candidate or campaign.',
    },
  ...
  const recites = [
    {
      ...
      url: 'https://commons.wikimedia.org/wiki/File:Daisy_(1964).webm',
      title: 'Wikimedia Commons file page for Daisy (1964)',
      publisher: 'Wikimedia Commons',
      sourceType: 'campaign_material',
      stance: 'context',
      claimText: 'The sample media is a historical 1964 political advertisement used for workflow demonstration.',
      quote: 'The Commons file identifies Daisy as an American political advertisement from 1964.',
      sourcePublishedAt: '1964',
      archiveUrl: 'https://commons.wikimedia.org/wiki/File:Daisy_(1964).webm',
    },
    {
      id: 'rec-ad-ext-roy-cooper-youtube',
      contentId: 'ad-ext-roy-cooper-easier-2026',
      url: 'https://upload.wikimedia.org/wikipedia/commons/5/5f/Daisy_%281964%29.webm',
      title: 'Direct video file for Daisy (1964)',
      publisher: 'Wikimedia Commons upload',
      sourceType: 'campaign_material',
      stance: 'context',
      claimText: 'The media URL is a direct video file so the native player can render without an embed provider.',
      quote: 'Direct WebM media file used for the sample outside-ad player.',
      sourcePublishedAt: '1964',
      archiveUrl: 'https://commons.wikimedia.org/wiki/File:Daisy_(1964).webm',
    },
    {
      ...
      url: 'https://commons.wikimedia.org/wiki/File:1952_Eisenhower_Political_Ad_-_I_Like_Ike_-_Presidential_Campaign_Ad.webm',
      title: 'Wikimedia Commons file page for I Like Ike (1952)',
      publisher: 'Wikimedia Commons',
      sourceType: 'campaign_material',
      stance: 'context',
      claimText: 'The sample media is a historical 1952 Republican political advertisement used for workflow demonstration.',
      quote: 'The Commons file identifies the video as a 1952 Eisenhower presidential campaign ad.',
      sourcePublishedAt: '1952',
      archiveUrl: 'https://commons.wikimedia.org/wiki/File:1952_Eisenhower_Political_Ad_-_I_Like_Ike_-_Presidential_Campaign_Ad.webm',
    },
    {
      ...
      title: 'Direct video file for I Like Ike (1952)',
      publisher: 'Wikimedia Commons upload',
      sourceType: 'campaign_material',
      stance: 'context',
      claimText: 'The media URL is a direct video file so the native player can render without an embed provider.',
  ...
  await db.batch(recites.map(recite =>
    db.prepare(
      `INSERT OR IGNORE INTO recites
       ...
       VALUES (?, 'ad', ?, 'system', ?, ?, ?, ?, ?, ?, ?, ?, '2026-07-06', ?, 'verified', 'system', '2026-07-06T00:00:00.000Z', ?)`
    ).bind(
      recite.id,
      recite.contentId,
      recite.url,
